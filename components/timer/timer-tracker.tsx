    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-8">
          <div className="text-7xl font-bold tabular-nums mb-6">{formatTime(timer.elapsedTime)}</div>

          <div className="flex gap-4">
            {!timer.isRunning ? (
              <Button onClick={() => startTimer()} size="lg" disabled={!timer.title} className="px-8">
            ...
            <Button onClick={stopTimer} variant="outline" size="lg" disabled={timer.elapsedTime === 0} className="px-8">
