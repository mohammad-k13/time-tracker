    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">{loading ? "..." : `${stats.completedEntries} completed`}</p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{loading ? "..." : secondsToHours(stats.totalDuration)}</div>
          <p className="text-xs text-muted-foreground">{loading ? "..." : formatTime(stats.totalDuration)}</p>
        </CardContent>
      </Card>
